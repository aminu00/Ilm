...
const translations: Record<Language, TranslationKeys> = {
  ...
  ar: {
    ...
    answeredTab: 'مُجاب',
    community: 'المجتمع',
    communityTagline: 'تواصل مع المسلمين',
    createCommunity: 'إنشاء مجتمع',
    communityCreated: 'تم إنشاء المجتمع!',
    communityCreateFailed: 'فشل في إنشاء المجتمع',
    communityName: 'اسم المجتمع',
    communityNameAr: 'اسم المجتمع (بالعربية)',
    communityDescription: 'الوصف (اختياري)',
    communityIcon: 'الأيقونة',
    noCommunities: 'لا توجد مجتمعات بعد',
    posts: 'منشورات',
    post: 'نشر',
    writePost: 'شارك شيئًا مع المجتمع...',
    postCreated: 'تم نشر المنشور!',
    postFailed: 'فشل في النشر',
  ...
  yo: {
    ...
    community: 'Àwùjọ',
    communityTagline: 'Bá àwọn Mùsùlùmí sọ̀rọ̀',
    createCommunity: 'Dá Àwùjọ',
    communityCreated: 'A ti dá àwùjọ!',
    communityCreateFailed: 'Kò le dá àwùjọ',
    communityName: 'Orúkọ àwùjọ',
    communityNameAr: 'Orúkọ àwùjọ (Lárúbáwá)',
    communityDescription: 'Àpèjúwe (àṣàyàn)',
    communityIcon: 'Àmì',
    noCommunities: 'Kò sí àwùjọ',
    posts: 'àwọn ifiranṣẹ́',
    post: 'Fi sílẹ̀',
    writePost: 'Pín nǹkan pẹ̀lú àwùjọ...',
    postCreated: 'A ti fi sílẹ̀!',
    postFailed: 'Kò le fi sílẹ̀',
    noPosts: 'Kò sí ifiranṣẹ́. Jẹ́ ẹni àkọ́kọ́!',
    postDeleted: 'A ti pa ifiranṣẹ́ rẹ́',
    reportPost: 'Ròyìn',
    reportSpam: 'Spam',
    reportInappropriate: 'Àkóónú tí kò yẹ',
    reportHarassment: 'Ìpaninilára',
    reportOther: 'Mìíràn',
    reportDetailsPlaceholder: 'Ṣàlàyé sí i (àṣàyàn)...',
    submitReport: 'Fi Ìròyìn Ránṣẹ́',
    reportSubmitted: 'A ti fi ìròyìn ránṣẹ́. O ṣeun!',
    reportFailed: 'Kò le fi ìròyìn ránṣẹ́',
    reports: 'Àwọn Ìròyìn',
    pendingReports: 'Ń dúró',
    resolvedReports: 'Tí a yanjú',
    dismissReport: 'Kọ̀',
    resolveReport: 'Yanjú',
    reportResolved: 'A ti yanjú ìròyìn',
    reportDismissed: 'A ti kọ ìròyìn',
  },
  ...
  ha: {
    ...
    answeredTab: 'An Amsa',
    community: 'Al\'umma',
    communityTagline: 'Haɗu da Musulmai',
    createCommunity: 'Ƙirƙiri Al\'umma',
    communityCreated: 'An ƙirƙiri al\'umma!',
    communityCreateFailed: 'Ba a iya ƙirƙiri al\'umma ba',
    communityName: 'Sunan al\'umma',
    communityNameAr: 'Sunan al\'umma (Larabci)',
    communityDescription: 'Bayani (zaɓi)',
    communityIcon: 'Alama',
    noCommunities: 'Babu al\'umma tukuna',
    posts: 'saƙonnin',
    post: 'Buga',
    writePost: 'Raba wani abu da al\'umma...',
    postCreated: 'An buga saƙo!',
    postFailed: 'Ba a iya buga saƙo ba',
    noPosts: 'Babu saƙonnin tukuna. Kasance na farko!',
    postDeleted: 'An share saƙo',
    reportPost: 'Rahoto',
    reportSpam: 'Spam',
    reportInappropriate: 'Abun ciki mara dacewa',
    reportHarassment: 'Wulaƙanci',
    reportOther: 'Wani',
    reportDetailsPlaceholder: 'Ƙara cikakkun bayanai (zaɓi)...',
    submitReport: 'Aika Rahoto',
    reportSubmitted: 'An aika rahoto. Na gode!',
    reportFailed: 'Ba a iya aika rahoto ba',
    reports: 'Rahotanni',
    pendingReports: 'Jiran aiki',
    resolvedReports: 'An warware',
    dismissReport: 'Watsar',
    resolveReport: 'Warware',
    reportResolved: 'An warware rahoto',
    reportDismissed: 'An watsar da rahoto',
  },
  ...
  ig: {
    ...
    answeredTab: 'Azaala',
    community: 'Obodo',
    communityTagline: 'Jikọọ na ndị Alakụba',
    createCommunity: 'Mepụta Obodo',
    communityCreated: 'Emepụtara obodo!',
    communityCreateFailed: 'Enweghị ike imepụta obodo',
    communityName: 'Aha obodo',
    communityNameAr: 'Aha obodo (Arabiikị)',
    communityDescription: 'Nkọwa (nhọrọ)',
    communityIcon: 'Akara',
    noCommunities: 'Enweghị obodo',
    posts: 'ederede',
    post: 'Tinye',
    writePost: 'Kekọrịta ihe na obodo...',
    postCreated: 'Etinyela ederede!',
    postFailed: 'Enweghị ike itinye ederede',
    noPosts: 'Enweghị ederede. Bụrụ onye mbụ!',
    postDeleted: 'Ehichapụla ederede',
    reportPost: 'Kpesara',
    reportSpam: 'Spam',
    reportInappropriate: 'Ihe na-ekwesịghị ekwesị',
    reportHarassment: 'Mmekpa ahụ',
    reportOther: 'Nke ọzọ',
    reportDetailsPlaceholder: 'Tinye nkọwa (nhọrọ)...',
    submitReport: 'Nyefee Mkpesa',
    reportSubmitted: 'Enyefela mkpesa. Daalụ!',
    reportFailed: 'Enweghị ike inyefe mkpesa',
    reports: 'Mkpesa',
    pendingReports: 'Na-echere',
    resolvedReports: 'Edoziri',
    dismissReport: 'Jụ',
    resolveReport: 'Dozie',
    reportResolved: 'Edoziri mkpesa',
    reportDismissed: 'Ajụla mkpesa',
  },
  ...
  pcm: {
    ...
    answeredTab: 'Answered',
    community: 'Community',
    communityTagline: 'Link up with fellow Muslims',
    createCommunity: 'Create Community',
    communityCreated: 'Community don create!',
    communityCreateFailed: 'Community no fit create',
    communityName: 'Community name',
    communityNameAr: 'Community name (Arabic)',
    communityDescription: 'Description (optional)',
    communityIcon: 'Icon',
    noCommunities: 'No community dey yet',
    posts: 'posts',
    post: 'Post',
    writePost: 'Share something with everybody...',
    postCreated: 'Post don share!',
    postFailed: 'Post no fit send',
    noPosts: 'No post dey yet. Be the first person!',
    postDeleted: 'Post don delete',
    reportPost: 'Report',
    reportSpam: 'Spam',
    reportInappropriate: 'Bad content',
    reportHarassment: 'Harassment',
    reportOther: 'Other',
    reportDetailsPlaceholder: 'Add details (optional)...',
    submitReport: 'Submit Report',
    reportSubmitted: 'Report don send. Thank you!',
    reportFailed: 'Report no fit send',
    reports: 'Reports',
    pendingReports: 'Pending',
    resolvedReports: 'Resolved',
    dismissReport: 'Dismiss',
    resolveReport: 'Resolve',
    reportResolved: 'Report don resolve',
    reportDismissed: 'Report don dismiss',
  },
};
